...
{
    /// <summary>
    /// The exception that is thrown when element location is null or
    ...
    public class InvalidCustomDataException : NotFoundException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the InvalidElementLocationException class with
        ...
        /// <summary>
        /// Initializes a new instance of the InvalidElementLocationException class with serialized data.
        /// </summary>
